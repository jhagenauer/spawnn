...
public class SyntheticSurface {
	...
	private static Logger log = Logger.getLogger(SyntheticSurface.class);
	public static void main(String[] args) {
		final Random r = new Random();
		
		//SampleBuilder.buildSyntheticSurfaceR(1000, "output/syn_surface.csv");
		...
		DataUtils.writeCSV("output/syn_surface_normed.csv", all, new String[]{"x","y","z"} );
		...
		for( final double alpha : new double[] { 0.0005 } ) // all error reduction

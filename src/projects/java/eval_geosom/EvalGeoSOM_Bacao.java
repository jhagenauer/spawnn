...
public class EvalGeoSOM_Bacao {

	private static Logger log = Logger.getLogger(EvalGeoSOM_Bacao.class);
	...
	public static void main(String[] args) {
		...
		try {
			for (double k : new int[]{ 0 } ) {
				...
				DataUtils.writeCSV("output/bacao.csv", samples, new String[]{"x", "y" } );
							...
							for (int run = 0; run < MAX_RUNS; run++) {
								...
								futures.add(es.submit(new Callable<double[]>() {
									...
									public double[] call() throws Exception {																				
										...
										//SomUtils.printUMatrix(grid, fDist, "output/geosom_"+RADIUS+".png");

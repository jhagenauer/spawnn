...
public class SpawnnGui extends JFrame implements PropertyChangeListener, ActionListener, ChangeListener, TrainingListener { // TODO A general class Prototype for GridPos, double[] etc. is needed
	...
	SpawnnGui() {
		...
		Image[] icons = new Image[] { kit.createImage(ClassLoader.getSystemResource("icon_20x20.png")), kit.createImage(ClassLoader.getSystemResource("icon_26x26.png")), kit.createImage(ClassLoader.getSystemResource("icon_32x32.png")), };
	...
	public static void main(String[] args) {
		/*
		 * try { UIManager.setLookAndFeel("javax.swing.plaf.nimbus.NimbusLookAndFeel"); } catch (Exception e) { try { UIManager.setLookAndFeel(UIManager.getCrossPlatformLookAndFeelClassName()); } catch (Exception ex) { ex.printStackTrace(); } }
		 */
		new SpawnnGui();
	}
